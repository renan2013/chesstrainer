            ...
            <div class="col">
                <div class="card h-100 text-center <?php echo ($category['estado'] == 0) ? 'bg-light' : ''; ?>">
                    <a href="categoria.php?category_id=<?php echo $category['id_categorias']; ?>" class="text-decoration-none text-dark">
                        ...
                        <?php endif; ?>
                        <?php if (!empty($category['imagen_categoria'])): ?>
                            <img src="admin/<?php echo htmlspecialchars($category['imagen_categoria']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($category['nombre_categoria']); ?>" style="height: 130px; object-fit: cover; <?php echo ($category['estado'] == 0) ? 'opacity: 0.6;' : ''; ?>">
                        <?php else: ?>
                            <img src="admin/uploads/categorias/loco.png" class="card-img-top" alt="Imagen por defecto" style="height: 130px; object-fit: cover; <?php echo ($category['estado'] == 0) ? 'opacity: 0.6;' : ''; ?>">
                        <?php endif; ?>
                        <div class="card-body">
