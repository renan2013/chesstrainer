...
protected $CurrentFont;        // current font object
...
protected $PageBreakTrigger;   // threshold to trigger auto page break
...
protected $iconv;              // flag indicating whether iconv is available
...
{
	// Check availability of some basic features
	if(!function_exists('version_compare') || version_compare(PHP_VERSION,'5.1.0','<'))
		$this->Error('PHP version must be at least 5.1.0');
	if(!function_exists('mb_strlen'))
		$this->Error('Extension iconv or mbstring is required');
...
protected function _dofontchecks()
{
	// Check availability of .ttf, .otf and .ttc support
	if(!function_exists('file_get_contents'))
		$this->Error('file_get_contents function is not available');
}
